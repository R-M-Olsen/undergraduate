import csv, exifread, os, subprocess, time
from easygui import *
...
# add option to keep and export output or retry extraction
# add option to run on single image
# add pyperclip for copy to clipboard
# use pyinstaller to compile completed script to exe
########################################################################################################################
#instructions